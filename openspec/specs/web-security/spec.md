...
## Purpose
Define the Web App boundary that keeps user-, Google Drive-, GAS-, and network-derived content inert unless intentional Markdown has passed through the shared sanitizer.
## Requirements
